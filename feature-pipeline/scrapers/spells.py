"""
This script uses Playwright to scrape spell data from the 5esrd.com website and save it to text files.
Modules:
...
Functions:
    run(playwright: Playwright) -> None:
        Launches a Chromium browser, navigates to the 5esrd.com website, and scrapes spell data.
...
def run(playwright: Playwright) -> None:
    ...
    time.sleep(2)
    page.get_by_role("link", name="Spells Database").click()
    time.sleep(2)
...
# Select all anchor tags within the first column of the table with id 'races'
    ...
    for href in hrefs:
        ...
        print(href)
        page.goto(href)
        race_characteristics = page.locator('//*[@id="article-content"]').first
        race_characteristics = race_characteristics.inner_text()
